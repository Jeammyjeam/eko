...
# Auto-generated CORTEX skill wrapper for: serena
# Serena provides essential semantic code retrieval, editing, refactoring and debugging tools that are

def execute_skill(query=""):
    args = ["serena", "--flag", "{query}"]
