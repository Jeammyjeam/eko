...
# Auto-generated CORTEX skill wrapper for: career_ops
# This skill wraps the Career-Ops CLI tool, an AI-driven multi-agent system designed to automate and o

def execute_skill(query=""):
    args = ["career-ops", "{query}"]
