...
# Auto-generated CORTEX skill wrapper for: deepseek_reasonix
# DeepSeek-Reasonix is a config- and plugin-driven AI coding agent for the terminal, written in Go. It
