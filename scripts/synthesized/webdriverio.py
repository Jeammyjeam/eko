...
# Auto-generated CORTEX skill wrapper for: webdriverio
# WebdriverIO is a test automation framework, for e2e as well as unit and component testing in the bro

def execute_skill(query=""):
    args = ["wdio", "--config", "{config}"]
