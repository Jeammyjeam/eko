...
# Auto-generated CORTEX skill wrapper for: nest
# Nest is a framework for building efficient, scalable Node.js server-side applications. It uses moder

def execute_skill(query=""):
    args = ["nest new my-project"]
