...
# Auto-generated CORTEX skill wrapper for: spec_kit
# An open source toolkit for building high-quality software with any AI coding agent — a ready-to-use 

def execute_skill(query=""):
    args = ["speckit", "--flag", "{query}"]
