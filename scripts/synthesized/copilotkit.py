...
# Auto-generated CORTEX skill wrapper for: copilotkit
# This skill wraps the CopilotKit CLI tool, enabling the creation and management of agent-native appli

def execute_skill(query=""):
    args = ["npx", "copilotkit@latest", "{query}"]
