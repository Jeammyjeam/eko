...
# Auto-generated CORTEX skill wrapper for: mailcatcher
# MailCatcher is a simple SMTP server that intercepts all emails sent to it and provides a web interfa
