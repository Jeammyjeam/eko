...
# Auto-generated CORTEX skill wrapper for: reactide
# Reactide is the first dedicated IDE for React web application development. It offers a simulator, ma

def execute_skill(query=""):
    args = ["reactide", "--flag", "{query}"]
