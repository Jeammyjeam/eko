...
# Auto-generated CORTEX skill wrapper for: huginn_agent
# Huginn is a system for building agents that perform automated tasks for you online. They can read th

def execute_skill(query=""):
    args = ["huginn-cli", "--flag", "{query}"]
