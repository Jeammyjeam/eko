...
# Auto-generated CORTEX skill wrapper for: llm_app
# The Pathway Live Data Framework's AI Pipelines allow you to quickly put in production AI application

def execute_skill(query=""):
    args = ["llm-app", "--flag", "{query}"]
