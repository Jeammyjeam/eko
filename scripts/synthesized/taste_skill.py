...
# Auto-generated CORTEX skill wrapper for: taste_skill
# Portable **Agent Skills** that upgrade AI-built interfaces: stronger layout, typography, motion, and

def execute_skill(query=""):
    args = ["taste-skill", "--flag", "{query}"]
