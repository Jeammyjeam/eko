...
# Auto-generated CORTEX skill wrapper for: learn_claude_code
# This repository teaches you how to build the vehicle for an agent product, including the model and h

def execute_skill(query=""):
    args = ["learn-claude-code", "--flag", "{query}"]
