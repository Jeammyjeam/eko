...
# Auto-generated CORTEX skill wrapper for: docling
# This skill uses Docling to intelligently process documents, extracting data and generating structure

def execute_skill(query=""):
    args = ["docling", "extract", "{query}", "--target", "json"]
