...
# Auto-generated CORTEX skill wrapper for: browser_use
# This skill wraps the Browser Use CLI tool, enabling control of an AI browser agent for various web a
