...
# Auto-generated CORTEX skill wrapper for: vanna_2_0
# Vanna 2.0 is a data science platform that turns natural language questions into SQL queries and retu

def execute_skill(query=""):
    args = ["vanna", "--flag", "{query}"]
