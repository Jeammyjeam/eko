...
# Auto-generated CORTEX skill wrapper for: rd_agent
# RD-Agent is a powerful tool that supports automated factor mining and model optimization in quant in

def execute_skill(query=""):
    args = ["pyqlib quant_factor_mining --query {query}"]
